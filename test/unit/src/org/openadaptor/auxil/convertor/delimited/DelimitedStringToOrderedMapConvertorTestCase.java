...
public class DelimitedStringToOrderedMapConvertorTestCase extends TestCase {

	DelimitedStringToOrderedMapConvertor convertor = null;
		
	public void setUp() {
		convertor = new DelimitedStringToOrderedMapConvertor();
	}
	...
	public void testInvalidRegEx() {
		String record = "one1two2'3three'3'f-o-u-r'4'five'";
		convertor.setDelimiter("[12345");
		convertor.setProtectQuotedFields(true);
		ArrayList exceptions = new ArrayList();
		convertor.validate(exceptions);
